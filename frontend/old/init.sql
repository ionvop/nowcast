...
CREATE TABLE "posts" (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `user_id` INTEGER REFERENCES `users`(`id`), `content` TEXT, `address` TEXT, `latitude` REAL, `longitude` REAL, `time` INTEGER DEFAULT (unixepoch()));
